...
import logo from '../../assets/img/sheriffTablet/logo.png';
import map from '../../assets/img/sheriffTablet/map.png';
import profil from '../../assets/img/sheriffTablet/image_user.png';

import '../../assets/css/sheriffTablet.css';

class SheriffTablet extends React.Component { 
    constructor(props) {
        super(props);
    ...
    sendSearchPlayer(e) {
        ...
        if(this.state.pageE.step === 1 || this.state.pageD.step === 1 || this.state.pageB.step === 1) {
            ...
            mp.trigger('tablet.sheriff.searchPlayer', "name", param);
        } else if(this.state.pageE.step === 2 || this.state.pageD.step === 2 || this.state.pageB.step === 2) {
            mp.trigger('tablet.sheriff.searchPlayer', "playerId", this.state.playerId);
        }
    }

    giveFine(e) {
        e.preventDefault();
        mp.trigger('tablet.sheriff.giveFine', this.state.searchPlayer, this.state.reason, this.state.summ);
    ...
    giveWanted(e) {
        e.preventDefault();
        mp.trigger('tablet.sheriff.giveWanted', this.state.searchPlayer, this.state.stars);
    ...
    _handleKeyDown = (event) => {
        switch(event.which) {
            case 113:
                if(window.clientStorage.faction === 3) {
    ...
    removeCall(id) {
        mp.trigger("tablet.sheriff.acceptCall", id);
    }

    callHelp(event) {
        if(event === "callTeamHelp") {
            mp.trigger('tablet.sheriff.callTeamHelp');
        } else if(event === "callHospitalHelp") {
            mp.trigger('tablet.sheriff.callHospitalHelp');
        } else if(event === "callFibHelp") {
            mp.trigger('tablet.sheriff.callFibHelp');
        }
    }
                ...
                <div className="tablet-background" style={{position: 'absolute', zIndex: '4', display: showTablet === true ? 'block' : 'none'}}>
                    <div className="imurfather">
                        <div className="header">
                            <div className="FIB newyorksixty">Los Santos County Sheriff</div>
                        ...
                        <div>
                            <div className="pageA">
                                ...
                                <div className="text">
                                    Используйте базу данных Los Santos County Sheriff, чтобы найти преступников среди
                        ...
                        <div>
                            <div class="pageF">
                                ...
                                <div class="beDown">
                                    ...
                                    нахождения ближайшему патрульному экипажу с сигналом “SOS”
                                </div>
...
const connectedLoginPage = connect(mapStateToProps)(SheriffTablet);
export { connectedLoginPage as SheriffTablet }; 