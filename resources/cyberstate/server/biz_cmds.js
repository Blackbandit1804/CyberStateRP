module.exports = {
    "create_biz": {
        ...
        handler: (player, args) => {
            ...
            args.splice(0, 2);
            var name = args.join(" ");
            alt.bizes.create(name, price, type, player.pos);
            terminal.info(`${player.getSyncedMeta("name")} создал бизнес "${name}" (цена: ${price}$, тип: ${type})`);
        }
    },
    "delete_biz": {
        ...
        syntax: "[ид_бизнеса]:n",
        handler: (player, args) => {
            alt.bizes.delete(args[0], (e) => {
                if (e) return terminal.error(e, player);
                terminal.info(`${player.getSyncedMeta("name")} удалил бизнес с ID: ${args[0]}`);
            });
        }
    },
    "set_biz_name": {
        ...
        handler: (player, args) => {
            var biz = alt.bizes.getBySqlId(args[0]);
            if (!biz) return terminal.error(`Бизнес с ID: ${args[0]} не найден!`, player);

            terminal.info(`${player.getSyncedMeta("name")} изменил имя у бизнеса с ID: ${args[0]}`);
            args.splice(0, 1);
    ...
    "set_biz_owner": {
        ...
        handler: (player, args) => {
            ...
            DB.Characters.getSqlIdByName(name, (sqlId) => {
                ...
                terminal.info(`${player.getSyncedMeta("name")} изменил владельца у бизнеса с ID: ${args[0]}`);
            });
        }
    },
    "delete_biz_owner": {
        ...
        handler: (player, args) => {
            ...
            biz.setOwner(0, '');
            terminal.info(`${player.getSyncedMeta("name")} удалил владельца у бизнеса с ID: ${args[0]}`);
        }
    },
    "set_biz_price": {
        ...
        handler: (player, args) => {
            ...
            biz.setPrice(args[1]);
            terminal.info(`${player.getSyncedMeta("name")} изменил цену у бизнеса с ID: ${args[0]}`);
        }
    },
    "set_biz_products": {
        ...
        handler: (player, args) => {
            ...
            terminal.info(`${player.getSyncedMeta("name")} изменил количество товара у бизнеса с ID: ${args[0]}`);
        }
    },
    "set_biz_maxproducts": {
        ...
        handler: (player, args) => {
            ...
            terminal.info(`${player.getSyncedMeta("name")} изменил вместимость склада у бизнеса с ID: ${args[0]}`);
        }
    },
    "set_biz_productprice": {
        ...
        handler: (player, args) => {
            ...
            terminal.info(`${player.getSyncedMeta("name")} изменил стоимость товара у бизнеса с ID: ${args[0]}`);
        }
    },
    "set_biz_balance": {
        ...
        handler: (player, args) => {
            ...
            terminal.info(`${player.getSyncedMeta("name")} изменил баланс у бизнеса с ID: ${args[0]}`);
        }
    },
    "set_biz_type": {
        ...
        handler: (player, args) => {
            ...
            biz.setType(args[1]);
            terminal.info(`${player.getSyncedMeta("name")} изменил тип у бизнеса с ID: ${args[0]}`);
        }
    },
    "set_biz_status": {
        ...
        handler: (player, args) => {
            ...
            terminal.info(`${player.getSyncedMeta("name")} изменил статус у бизнеса с ID: ${args[0]}`);
        }
    },
    "set_biz_position": {
        ...
        handler: (player, args) => {
            ...
            biz.setPosition(player.pos);
            terminal.info(`${player.getSyncedMeta("name")} изменил позицию у бизнеса с ID: ${args[0]}`);
        }
    },
    "tp_biz": {
