  module.exports = {
      ...
      "cutscene_stop": {
          ...
          syntax: "",
          handler: (player, args) => {
            alt.emitClient(player, `finishMoveCam`);
          }
      },
      "cutscenes_list": {
          ...
          handler: (player, args) => {
              ...
              for (var i in alt.cutscenes) {
                  var c = alt.cutscenes[i];
      ...
      "set_cutscene_name": {
          ...
          syntax: "[id]:n [name]:s",
          handler: (player, args) => {
              var c = alt.cutscenes[args[0]];
              if (!c) return terminal.error(`Катсцена с ID: ${args[0]} не найдена!`, player);
              args.splice(0, 1);
              c.setName(args.join(" "));
              terminal.info(`${player.getSyncedMeta("name")} изменил имя у катсцены с ID: ${c.id}`);
          }
      },
      "set_cutscene_finaltext": {
          ...
          handler: (player, args) => {
              ...
              terminal.info(`${player.getSyncedMeta("name")} изменил финальный текст у катсцены с ID: ${c.id}`);
          }
      },
      "cutscene_points": {
      ...
      "set_cutscene_point_text": {
          ...
          handler: (player, args) => {
              ...
              terminal.info(`${player.getSyncedMeta("name")} изменил текст у кадра катсцены с ID: ${pId}`);
          }
      },
      "set_cutscene_point_speed": {
          ...
          handler: (player, args) => {
              ...
              terminal.info(`${player.getSyncedMeta("name")} изменил скорость полеты камеры у кадра катсцены с ID: ${pId}`);
          }
      },
      "set_cutscene_point_startpos": {
          ...
          handler: (player, args) => {
              ...
              var p = c.points[pId];
              if (!p) return terminal.error(`Кадр катсцены с ID: ${args[1]} не найден!`, player);
              var pos = new alt.Vector3(args[2], args[3], args[4]);
              c.setPointStartPositon(pId, pos);
              terminal.info(`${player.getSyncedMeta("name")} изменил начальную позицию камеры у кадра катсцены с ID: ${pId}`);
          }
      },
      "set_cutscene_point_endpos": {
          ...
          handler: (player, args) => {
              ...
              terminal.info(`${player.getSyncedMeta("name")} изменил конечную позицию камеры у кадра катсцены с ID: ${pId}`);
          }
      },
      "set_cutscene_point_startrot": {
          ...
          handler: (player, args) => {
              ...
              terminal.info(`${player.getSyncedMeta("name")} изменил начальный поворот камеры у кадра катсцены с ID: ${pId}`);
          }
      },
      "set_cutscene_point_endrot": {
          ...
          handler: (player, args) => {
              ...
              terminal.info(`${player.getSyncedMeta("name")} изменил конечный поворот камеры у кадра катсцены с ID: ${pId}`);
          }
      },
      "cutscene_add_point": {
          ...
          handler: (player, args) => {
              ...
              terminal.info(`${player.getSyncedMeta("name")} добавил кадр к катсцене с ID: ${c.id}`);
          }
      },
      "cutscene_delete_point": {
          ...
          handler: (player, args) => {
              ...
              terminal.info(`${player.getSyncedMeta("name")} удалил кадр у катсцены с ID: ${c.id}`);
          }
      },
  }
