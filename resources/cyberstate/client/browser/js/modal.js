    ...
    var modals = {
        ...
        "biz_balance_add": {
            ...
            on: () => {
                ...
                var handler = () => {
                    ...
                    if (!isFlood()) {
                        alt.emit("events.emitServer", "biz.balance.add", sum);
                        modalAPI.hide();
                    }
                };
        ...
        "biz_products_buy": {
            ...
            on: (values) => {
                ...
                var handler = () => {
                    ...
                    if (!isFlood()) {
                        alt.emit("events.emitServer", "biz.products.buy", products);
                        modalAPI.hide();
                    }
                };
        ...
        "biz_products_sell": {
            ...
            on: (values) => {
                ...
                var handler = () => {
                    ...
                    if (!isFlood()) {
                        alt.emit("events.emitServer", "biz.products.sell", products);
                        modalAPI.hide();
                    }
                };
                $(".modal .products").on("keydown", (e) => {
        ...
        "biz_products_price": {
            ...
            on: (values) => {
                ...
                var handler = () => {
                    ...
                    if (!isFlood()) {
                        alt.emit("events.emitServer", "biz.products.price", productPrice);
                        modalAPI.hide();
                    }
                };
        ...
        "biz_sell_to_player": {
            ...
            on: (values) => {
                ...
                var handler = () => {
                    ...
                    if (!isFlood()) {
                        alt.emit("events.emitServer", "biz.sell", JSON.stringify([buyerName, price]));
                    }
                };
        ...
        "biz_sell_to_gov": {
            ...
            on: (values) => {
                ...
                var handler = () => {
                    if (!isFlood()) {
                        alt.emit("events.emitServer", "biz.sellToGov");
                        modalAPI.hide();
                    }
                };
                $(".modal button").on("click", () => {
        ...
        "biz_buy": {
            ...
            on: (values) => {
                ...
                var handler = () => {
                    if (!isFlood()) {
                        alt.emit("events.emitServer", "biz.buy");
                        modalAPI.hide();
                    }
                };
                $(".modal button").on("click", () => {
        ...
        "give_wanted": {
            ...
            on: (values) => {
                ...
                var handler = () => {
                    ...
                    if (!isFlood()) {
                        alt.emit("events.emitServer", "giveWanted", JSON.stringify([playerId, wanted, reason]));
                        modalAPI.hide();
                    }
                };
        ...
        "give_fine": {
            ...
            on: (values) => {
                ...
                var handler = () => {
                    ...
                    if (reason.length > 30) reason = reason.substr(0, 30) + "...";
                    if (!isFlood()) {
                        alt.emit("events.emitServer", "giveFine", JSON.stringify([playerId, sum, reason]));
                        modalAPI.hide();
                    }
                };
                $(".modal .sum").on("keydown", (e) => {
        ...
        "clear_fine": {
            ...
            on: (values) => {
                ...
                var handler = () => {
                    ...
                    if (!isFlood()) {
                        alt.emit("events.emitServer", "policeService.clearFine");
                        modalAPI.hide();
                    }
                };
                $(".modal button").on("click", () => {
        ...
        "invite_player_inhouse": {
            ...
            on: (values) => {
                ...
                var handler = () => {
                    ...
                    if (!isFlood()) {
                        alt.emit("events.emitServer", "invitePlayerInHouse", JSON.stringify([player]));
                        modalAPI.hide();
                    }
                };
            ...
            off: () => {
                ...
                alt.emit("events.emitServer", "houseMenuHandler");
                clearOnlyInt(".modal .wanted");
        ...
        "sell_player_house": {
            ...
            on: (values) => {
                ...
                var handler = () => {
                    ...
                    if (!isFlood()) {
                        alt.emit("events.emitServer", "sellHousePlayer", JSON.stringify([player, price]));
                        modalAPI.hide();
                    }
                };
                $(".modal .player").on("keydown", (e) => {
        ...
        "sell_player_car": {
            ...
            on: (values) => {
                ...
                var handler = () => {
                    ...
                    if (!isFlood()) {
                        alt.emit("events.emitServer", "sellCarPlayer", JSON.stringify([player, price, values.sqlId]));
                        modalAPI.hide();
                    }
                };
                $(".modal .player").on("keydown", (e) => {
        ...
        "help_menu": {
            ...
            off: () => {
                $(".modal button").off("click");
                alt.emit('update.help.main.open', false);
            }
        },
        "bank_money_put": {
            ...
            off: () => {
                $(".modal button").off("click");
                alt.emit('update.bank.main.open', false);
            },
        },
        "pass_money_player": {
            ...
            on: (values) => {
                ...
                var handler = () => {
                    var money = $(".modal .mbank_put").val().trim();
                    alt.emit("pass.player.money", money, values.interactionId);
                };
        ...
        "item_split": {
            ...
            on: (values) => {
                ...
                var item = window.inventoryAPI.getItem(values.itemSqlId);
                if (!item) {
                    modalAPI.hide();
                ...
                var handler = () => {
                    ...
                    if (!isFlood()) {
                        alt.emit("events.emitServer", "item.split", JSON.stringify([values.itemSqlId, countVal]));
                        modalAPI.hide();
                    }
                };
        ...
        "bank_money_take": {
            ...
            on: (values) => {
                ...
                var handler = () => {
                    ...
                    alt.emit("take.bank.money", money);
                };
                $(".modal .balance_bank").text(`$${values.money}`);
        ...
        "bank_money_transfer": {
            ...
            on: (values) => {
                ...
                var handler = () => {
                    ...
                    alt.emit("transfer.bank.money", name, money);
                };
                $(".modal .balance_bank").text(`$${values.money}`);
        ...
        "bank_money_house_give": {
            ...
            on: (values) => {
              ...
              var handler = () => {
                  ...
                  alt.emit("give.bank.money.house", money, values.house);
              };
              $(".modal .balance_bank").text(`$${values.money}`);
        ...
        "gang_money_take": {
            ...
            on: (values) => {
                ...
                var handler = () => {
                    var money = $(".modal .mbank_take").val().trim();
                    alt.emit("gang.take.money", money);
                };
                $(".modal .balance_bank").text(`$${values.money}`);
                $(".modal .mbank_take").on("keydown", (e) => {
                    if (e.keyCode == 13) handler();
        ...
        "allow_gang_menu0": {
            ...
            on: (values) => {
                ...
                var handler = () => {
                    ...
                    alt.emit("gang.control.allow", 0, count);
                };
        ...
        "allow_gang_menu1": {
            ...
            on: (values) => {
                ...
                var handler = () => {
                    var count = $(".modal .mbank_put").val().trim();
                    alt.emit("gang.control.allow", 1, count);
                };
                $(".modal .balance_bank").text(`${values.rank}`);
                $(".modal .mbank_put").on("keydown", (e) => {
                    if (e.keyCode == 13) handler();
        ...
        "allow_gang_menu4": {
            ...
            on: (values) => {
                ...
                var handler = () => {
                    var count = $(".modal .mbank_put").val().trim();
                    alt.emit("gang.control.allow", 4, count);
                };
                $(".modal .balance_bank").text(`${values.rank}`);
                $(".modal .mbank_put").on("keydown", (e) => {
                    if (e.keyCode == 13) handler();
        ...
        "allow_gang_menu2": {
            ...
            on: (values) => {
                ...
                var handler = () => {
                    var count = $(".modal .mbank_put").val().trim();
                    alt.emit("gang.control.allow", 2, count);
                };
                $(".modal .balance_bank").text(`${values.rank}`);
                $(".modal .mbank_put").on("keydown", (e) => {
                    if (e.keyCode == 13) handler();
        ...
        "allow_gang_menu3": {
            ...
            on: (values) => {
                ...
                var handler = () => {
                    var count = $(".modal .mbank_put").val().trim();
                    alt.emit("gang.control.allow", 3, count);
                };
                $(".modal .balance_bank").text(`${values.rank}`);
                $(".modal .mbank_put").on("keydown", (e) => {
                    if (e.keyCode == 13) handler();
        ...
        "gang_drugs_put": {
            ...
            on: (values) => {
                ...
                var handler = () => {
                    var count = $(".modal .mbank_put").val().trim();
                    alt.emit("gang.control.drugs", count, values.id, values.type);
                };
        ...
        "gang_ammo_put": {
            ...
            on: (values) => {
                ...
                var handler = () => {
                    var count = $(".modal .mbank_put").val().trim();
                    alt.emit("gang.control.ammo", count, values.id, values.type);
                };
                $(".modal .balance_bank").text(`${values.count}`);
                $(".modal .drug_name").text(`${values.drug_name}`);
                $(".modal .mbank_put").on("keydown", (e) => {
        ...
        "throw_from_vehicle": {
            ...
            on: (values) => {
                ...
                var handler = () => {
                    ...
                    alt.emit("throw.fromvehicle.withkey", id);
                };
        ...
        "bank_money_house_take": {
            ...
            on: (values) => {
                ...
                var handler = () => {
                    ...
                    alt.emit("take.bank.money.house", money, values.house);
                };
                $(".modal .balance_bank").text(`$${values.money}`);
                $(".modal .number_bhouse").text(`${values.house}`);
                $(".modal .balance_bank_house").text(`${values.bhouse}`);
...
alt.on(`modalAPI.show`, (modalName, values) => {
    modalAPI.show(modalName, values);
});

alt.on(`modalAPI.hide`, () => {
    modalAPI.hide();
});