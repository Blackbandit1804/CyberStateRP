const app = new Vue({
    ...
    data: {
        ...
        taxiLogIn: {
            ...
            NameStringFinal: 'Cyber State Project',
    ...
    methods: {
        ...
        stage3() {
            setTimeout(() => {
                ...
                alt.emit('events.emitServer', 'accept.taxi.day');
            }, 1500);
        },
        ...
        updateList() {
            alt.emit('events.emitServer', 'update.taxi.orders');
        },
        ...
        EndOrder() {
            ...
            alt.emit('events.emitServer', 'cancels.taxi.order');
        },
    },
});
